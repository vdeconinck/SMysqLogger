...
//  Updated May 2011 by Vincent Deconinck to allow a variable number of decimals
//============================================================================//
...
function Odometer (parentDiv,opts) {
	...
	for (var i = 1; i <= this.decimals; i++) {
		digitInfo[this.digits - i].digitA.style.background = "#cccccc";
		digitInfo[this.digits - i].digitB.style.background = "#cccccc";
		digitInfo[this.digits - i].digitA.style.color = "#000000";
		digitInfo[this.digits - i].digitB.style.color = "#000000";
    }
